...
define("PAYPAL_CREDENTIALS", array(
	"sandbox" => [
		"client_id" => "Ab9LOTR2uxWzZAtl-lPWqxsZtUPrLCYbG-aPVdlmcxUnrA7AjwgBB_iKddRyrvZIDr0kvCm7XkurpyPV",
		"client_secret" => "EKo2IsgTB5HHCqlf441g6l_PHFaEEyv67WgUA22kMWo0bnfP6tE64Jqyhs3xtRMtaneLSuMy6ZaLiRO_"
	],
	"production" => [
		"client_id" => "",
		"client_secret" => ""
